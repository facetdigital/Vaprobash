...
COUCHBASE_VERSION=4.0.0 # Check http://http://www.couchbase.com/download/ for latest version
...
if [ ${PHP_IS_INSTALLED} -eq 0 ]; then
    ...
    sudo apt-get update
    sudo apt-get -qq install libcouchbase-dev build-essential zlib1g-dev
